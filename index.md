...
In the various courses I've taken in the program, I've learned how to collaborate in a team environment and communicate with stakeholders, as well as improved my skills in data structures and algorithms, software engineering, databases, and security. In [(CS-360 Mobile Architecture and Programming)](https://github.com/michaelTurco/CS-360-Mobile-Architecture-And-Programming) and in [(CS-465 Full Stack Development)](https://github.com/michaelTurco/CS-465-Full-Stack-Development), we had to create a GitHub repository and make consistent pushes throughout the course until we completed the project. GitHub is a widely used professional tool in the industry, and working with it throughout these courses has strengthened my ability to use it effectively. I learned to write readable commit messages and make structured commits instead of tons of unrelated changes together, and I came to understand how valuable GitHub is for making collaboration easy and efficient in any kind of project.
