...
In [CS-465 Full-Stack Development](https://github.com/michaelTurco/CS-465-Full-Stack-Development), I worked on **Travlr**, handling both the front-end and back-end development. I created a specialized admin page for editing and creating new travel packages, implemented user authentication through web requests, and connected the UI with the data stored in MongoDB.

In [CS-330 Computer Graphics and Visualization](https://github.com/michaelTurco/CS-330-Computer-Graphics-and-Visualization), I worked on recreating a reference image in a 3D scene using OpenGL and C++.
